...
class BaseGameTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.q1 = Question.objects.create(
            category=self.category, text="Question 1", answer="Answer 1",
            points=100, order=1
        )
        self.q2 = Question.objects.create(
            category=self.category, text="Question 2", answer="Answer 2",
            points=200, order=2
        )
        self.q3 = Question.objects.create(
            category=self.category, text="Question 3", answer="Answer 3",
            points=300, order=3
        )
